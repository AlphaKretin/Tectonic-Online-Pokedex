...
function populateTable(name, data) {
  ...
  tracker.data = data;
  for (const control of tracker.sortControls) control.className = "sortOption";
...
function sortTracker(selectedOption, tracker, sortMethod, sortProperties) {
  ...
  for (const option of tracker.sortControls) option.className = "sortOption";
